...
class edu003_eduXpertForms{

    static function displayEduXpertConsultationForm(){
        global $posts;
        ...
        <form class="ec-form" method="post">
            <div class="container overflow-auto" style="height: 65vh;">
                ...
                <div class="row">
                    <h2 style="font-size: 20px; text-align: center;">Formulir Konsultasi EduXpert</h2>
                    <p style="text-align: justify;">Isi data diri Anda di form bawah ini untuk melakukan konsultasi dengan Education Counsellor EduXpert:</p>
                    ...
                    <div class="form-group">
                        <select name="lastestEducation" id="lastestEducation" class="form-control custom-select text-center" required>
                    ...
                    <div class="form-group">
                        <select name="collegeFinancing" id="collegeFinancing" class="form-control custom-select text-center" required>
                    ...
                    <div class="form-group">
                        <select name="chosenProgram" id="chosenProgram" class="form-control custom-select text-center" required>
                    ...
                    <div class="form-group">
                        <select name="englishSkills" id="englishSkills" class="form-control custom-select text-center" required>
