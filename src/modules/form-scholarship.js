        ...
        $(document).ready(function(){
            $('.s-form').validate({
                ...
                submitHandler: function(){
                    ...
                    $.ajax({
                        url: "https://script.google.com/macros/s/AKfycby1n8_hjhmihDcoHXmJkIw6e-7lvdj2SRSVT-0mFgrrXW7zT1mgTHaAmLu80ZWu9kC2/exec",
...
export default edu003_scholarshipForm;