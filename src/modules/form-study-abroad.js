        ...
        $(document).ready(function(){
            ...
            $('.sa-form').validate({
                ...
                submitHandler: function(){
                    ...
                    $.ajax({
                        url: 'https://script.google.com/macros/s/AKfycbwXCb95fceZsG2ozsm1_rwxboFVOBqj6z6tx67hBOkk_hVEYh-PC9qteBBq2bQipKE_hA/exec',
                        data: $('.sa-form').serialize(),
                        type: 'POST',
                        beforeSend:function(){
...
export default edu003_studyAbroadForm;